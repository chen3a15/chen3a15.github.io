      ...
      return this.each(
        function()
        {
          ...
          if (settings.window.expandable)
            $($this).after('<span class="jPicker"><span class="Icon"><span class="Color">&nbsp;</span><span class="Alpha">&nbsp;</span><span class="Image" title="打开颜色选取面板">&nbsp;</span><span class="Container">&nbsp;</span></span></span>');
                  ...
                  settings.window.input.css(
                    {
                      ...
                      color: va == null || 'rgb('+(255-rgb.r)+','+(255-rgb.g)+','+(255-rgb.b)+')'//增加的代码，用互补色更清晰
                    });
                //增加的代码，选择颜色时同步生成剪切照片
                if (hex){$('#backColorChanged').html(hex);}else{$('#backColorChanged').html('null');}
              },
            moveBarMouseDown =
              function(e)
              {
